            ...
            <form action="{{ url('/pay') }}" method="POST" class="needs-validation">
                ...
                <ul class="list-group mb-3">
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">{{ session('total_from_cart') }}</span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                        ...
                        <span class="text-muted">{{ session('discount_from_cart') }}</span>
                    </li>

                    <li class="list-group-item d-flex justify-content-between">
                        <span>Sub Total (BDT)</span>
                        <strong>{{ session('total_from_cart') - session('discount_from_cart') }}TK</strong>
                    </li>
                </ul>
                {{-- <div class="row">
                ...
                <hr class="mb-4"> --}}
                <button class="btn btn-primary btn-lg btn-block" type="submit">Continue to checkout SSL</button>
            </form>
        </div>
    </div>
