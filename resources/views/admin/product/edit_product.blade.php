                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ url('/product/update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" name="id" value="{{ $product_edit->id }}>
                                                                            <label for="">Category list</label>
                                                                            <select name=" category_id" id=""
                                            class="form-control">
                                        <option value="">---Select category---</option>
                                        @foreach ($categories as $category)
                                            <option {{ $product_edit->category_id == $category->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="subcategory_id" id="" class="form-control">
                                            ...
                                            @foreach ($subcategories as $subcategory)
                                                <option
                                                    {{ $product_edit->subcategory_id == $subcategory->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="best_selling" class="form-control">
                                            ...
                                            <option value="BestSellingProduct">Best Selling</option>
                                            <option value="SpecialDeal">Special Deal Product</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
