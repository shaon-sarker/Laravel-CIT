                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ url('/product/insert') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="best_selling" id="" class="form-control">
                                            <option value="">---Select Product list---</option>
                                            <option value="best_selling_product">Best Selling</option>
                                            <option value="special_deal_product">Special Deal Product</option>
                                        </select>
                                    </div>
