                                    ...
                                    <tbody>
                                        @forelse ($products as $product)
                                            <tr>
                                                ...
                                                <td>{{ App\Models\Subcategory::find($product->subcategory_id)->subcategory_name }}
                                                </td>
                                                <td><img width="150px"
                                                ...
                                                <td><a href="{{ url('/product/edit') }}/{{ $product->id }}"
                                                        class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a></td>
                                                <td><a href="{{ url('/product/delete') }}/{{ $product->id }}"
