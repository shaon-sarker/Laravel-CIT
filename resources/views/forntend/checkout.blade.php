                ...
                <div class="container">
                    <div class="row">
                        ...
                        <li>Pure Nature Honey <span class="pull-right">$141.00</span></li> --}}
                                    ...
                                    <li>Total <span
                                            class="
                                        pull-right"><strong>{{ session('total_from_cart') }}</strong></span>
                                    </li>
                                    <li>Discount <span class="pull-right">{{ session('discount_from_cart') }}</span></li>
                                    <li>Subtotal<span
                                            class="pull-right">{{ session('total_from_cart') - session('discount_from_cart') }}</span>
                                    </li>
                                </ul>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 m-auto">
                        <div class="my-5">
                            <h3 class="alert alert-info">you are not customer-----> <a href="{{ url('/') }}">Go home</a>
                                </h1>
                        </div>
                    </div>
                </div>
